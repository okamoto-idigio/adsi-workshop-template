...
import { CustomActionTypeReference, ICustomActionTypeRef, IPipelineRef, IWebhookRef, PipelineReference, WebhookReference } from "../../interfaces/generated/aws-codepipeline-interfaces.generated";
...
export declare class CfnCustomActionType extends cdk.CfnResource implements cdk.IInspectable, ICustomActionTypeRef, cdk.ITaggable {
     ...
     */
    static isCfnCustomActionType(x: any): x is CfnCustomActionType;
    /**
     ...
     */
    private _configurationProperties?;
    /**
     ...
     * The configuration properties for the custom action.
     */
    get configurationProperties(): Array<CfnCustomActionType.ConfigurationPropertiesProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The configuration properties for the custom action.
     */
    set configurationProperties(value: Array<CfnCustomActionType.ConfigurationPropertiesProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The details of the input artifact for the action, such as its commit ID.
     */
    get inputArtifactDetails(): CfnCustomActionType.ArtifactDetailsProperty | cdk.IResolvable;
    /**
     * The details of the input artifact for the action, such as its commit ID.
     */
    set inputArtifactDetails(value: CfnCustomActionType.ArtifactDetailsProperty | cdk.IResolvable);
    /**
     * The details of the output artifact of the action, such as its commit ID.
     */
    get outputArtifactDetails(): CfnCustomActionType.ArtifactDetailsProperty | cdk.IResolvable;
    /**
     * The details of the output artifact of the action, such as its commit ID.
     */
    set outputArtifactDetails(value: CfnCustomActionType.ArtifactDetailsProperty | cdk.IResolvable);
    /**
     * The provider of the service used in the custom action, such as CodeDeploy.
     */
    get provider(): string;
     ...
     * URLs that provide users information about this custom action.
     */
    get settings(): cdk.IResolvable | CfnCustomActionType.SettingsProperty | undefined;
    /**
     * URLs that provide users information about this custom action.
     */
    set settings(value: cdk.IResolvable | CfnCustomActionType.SettingsProperty | undefined);
    /**
     * The tags for the custom action.
     */
...
export declare class CfnPipeline extends cdk.CfnResource implements cdk.IInspectable, IPipelineRef, cdk.ITaggable {
     ...
     */
    private _artifactStores?;
    /**
     * Represents the input of a `DisableStageTransition` action.
     */
    private _disableInboundStageTransitions?;
    /**
     ...
     */
    private _restartExecutionOnUpdate?;
    /**
     ...
     * The S3 bucket where artifacts for the pipeline are stored.
     */
    get artifactStore(): CfnPipeline.ArtifactStoreProperty | cdk.IResolvable | undefined;
    /**
     * The S3 bucket where artifacts for the pipeline are stored.
     */
    set artifactStore(value: CfnPipeline.ArtifactStoreProperty | cdk.IResolvable | undefined);
    /**
     * A mapping of `artifactStore` objects and their corresponding AWS Regions.
     */
    get artifactStores(): Array<CfnPipeline.ArtifactStoreMapProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A mapping of `artifactStore` objects and their corresponding AWS Regions.
     */
    set artifactStores(value: Array<CfnPipeline.ArtifactStoreMapProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Represents the input of a `DisableStageTransition` action.
     */
    get disableInboundStageTransitions(): Array<cdk.IResolvable | CfnPipeline.StageTransitionProperty> | cdk.IResolvable | undefined;
    /**
     * Represents the input of a `DisableStageTransition` action.
     */
    set disableInboundStageTransitions(value: Array<cdk.IResolvable | CfnPipeline.StageTransitionProperty> | cdk.IResolvable | undefined);
    /**
     * The method that the pipeline will use to handle multiple executions.
     */
    get executionMode(): string | undefined;
    /**
     * The method that the pipeline will use to handle multiple executions.
     */
    set executionMode(value: string | undefined);
    /**
     * The name of the pipeline.
     */
     ...
     * CodePipeline provides the following pipeline types, which differ in characteristics and price, so that you can tailor your pipeline features and cost to the needs of your applications.
     */
    get pipelineType(): string | undefined;
    /**
     * CodePipeline provides the following pipeline types, which differ in characteristics and price, so that you can tailor your pipeline features and cost to the needs of your applications.
     */
    set pipelineType(value: string | undefined);
    /**
     * Indicates whether to rerun the CodePipeline pipeline after you update it.
     */
    get restartExecutionOnUpdate(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether to rerun the CodePipeline pipeline after you update it.
     */
    set restartExecutionOnUpdate(value: boolean | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) for CodePipeline to use to either perform actions with no `actionRoleArn` , or to use to assume roles for actions with an `actionRoleArn` .
     */
    get roleArn(): string;
     ...
     * Represents information about a stage and its definition.
     */
    get stages(): Array<cdk.IResolvable | CfnPipeline.StageDeclarationProperty> | cdk.IResolvable;
    /**
     * Represents information about a stage and its definition.
     */
    set stages(value: Array<cdk.IResolvable | CfnPipeline.StageDeclarationProperty> | cdk.IResolvable);
    /**
     * Specifies the tags applied to the pipeline.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * The trigger configuration specifying a type of event, such as Git tags, that starts the pipeline.
     */
    get triggers(): Array<cdk.IResolvable | CfnPipeline.PipelineTriggerDeclarationProperty> | cdk.IResolvable | undefined;
    /**
     * The trigger configuration specifying a type of event, such as Git tags, that starts the pipeline.
     */
    set triggers(value: Array<cdk.IResolvable | CfnPipeline.PipelineTriggerDeclarationProperty> | cdk.IResolvable | undefined);
    /**
     * A list that defines the pipeline variables for a pipeline resource.
     */
    get variables(): Array<cdk.IResolvable | CfnPipeline.VariableDeclarationProperty> | cdk.IResolvable | undefined;
    /**
     * A list that defines the pipeline variables for a pipeline resource.
     */
    set variables(value: Array<cdk.IResolvable | CfnPipeline.VariableDeclarationProperty> | cdk.IResolvable | undefined);
    /**
 ...
 */
export declare class CfnWebhook extends cdk.CfnResource implements cdk.IInspectable, IWebhookRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    static isCfnWebhook(x: any): x is CfnWebhook;
    /**
     * Creates a new IWebhookRef from a webhookName
     */
    static fromWebhookName(scope: constructs.Construct, id: string, webhookName: string): IWebhookRef;
    static arnForWebhook(resource: IWebhookRef): string;
    /**
     ...
     */
    private _registerWithThirdParty?;
    /**
     ...
     */
    private _targetPipelineVersion?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * Properties that configure the authentication applied to incoming webhook trigger requests.
     */
    get authenticationConfiguration(): cdk.IResolvable | CfnWebhook.WebhookAuthConfigurationProperty;
    /**
     * Properties that configure the authentication applied to incoming webhook trigger requests.
     */
    set authenticationConfiguration(value: cdk.IResolvable | CfnWebhook.WebhookAuthConfigurationProperty);
    /**
     * A list of rules applied to the body/payload sent in the POST request to a webhook URL.
     */
    get filters(): Array<cdk.IResolvable | CfnWebhook.WebhookFilterRuleProperty> | cdk.IResolvable;
    /**
     * A list of rules applied to the body/payload sent in the POST request to a webhook URL.
     */
    set filters(value: Array<cdk.IResolvable | CfnWebhook.WebhookFilterRuleProperty> | cdk.IResolvable);
    /**
     * The name of the webhook.
     */
    get name(): string | undefined;
     ...
     * Configures a connection between the webhook that was created and the external tool with events to be detected.
     */
    get registerWithThirdParty(): boolean | cdk.IResolvable | undefined;
    /**
     * Configures a connection between the webhook that was created and the external tool with events to be detected.
     */
    set registerWithThirdParty(value: boolean | cdk.IResolvable | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
     ...
     * The version number of the pipeline to be connected to the trigger request.
     */
    get targetPipelineVersion(): number | undefined;
    /**
     * The version number of the pipeline to be connected to the trigger request.
     */
    set targetPipelineVersion(value: number | undefined);
    /**
...
export type { ICustomActionTypeRef, CustomActionTypeReference };
export type { IPipelineRef, PipelineReference };
export type { IWebhookRef, WebhookReference };
