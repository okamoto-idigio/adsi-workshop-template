...
const zip_1 = require("@aws-cdk/private-tools/lib/zip");
...
async function generateCdkApp(ioHelper, stackName, stack, language, outputPath, compress) {
    ...
    try {
        ...
        if (compress) {
            await (0, zip_1.zipDirectory)(resolvedOutputPath, `${resolvedOutputPath}.zip`);
            fs.rmSync(resolvedOutputPath, { recursive: true, force: true });
        }
    }
    catch (error) {
...
function printBar(width, progress) {
    if (!process.env.MIGRATE_INTEG_TEST) {
        ...
        const color = chalk_1.default.green;
